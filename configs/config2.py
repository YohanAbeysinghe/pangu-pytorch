...
__C.PG_OUT_PATH = os.path.join('/l/users/yohan.abeysinghe/pangu/results')
...
__C.PG.HORIZON = 24
__C.PG.TRAIN = edict()
__C.PG.TRAIN.EPOCHS = 4
__C.PG.TRAIN.LR = 5e-6 #5e-4
__C.PG.TRAIN.WEIGHT_DECAY = 3e-7 #3e-6
__C.PG.TRAIN.START_TIME =  '20130101' #'20030101'
