...
__C.GLOBAL.MODEL = 'original' #'original'
...
__C.PG_OUT_PATH = os.path.join('/scratch/project_462000803/akhtar/climate_project/data/pangu_data/results/non_cropped')
...
__C.PG.TRAIN.LR = 5e-7 #5e-4
__C.PG.TRAIN.WEIGHT_DECAY = 3e-6
__C.PG.TRAIN.START_TIME =  '20030101'
