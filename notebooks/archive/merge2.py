...
surface_folder = '/pfs/lustrep1/scratch/project_462000472/akhtar/climate_modeling/pangu-data/data_prep/surface/surface_mena_12hour/2019'
cams_folder = '/pfs/lustrep1/scratch/project_462000472/akhtar/climate_modeling/pangu-data/data_prep/pm25/cropped_regridded_025_renamed/2019'
output_folder = '/pfs/lustrep1/scratch/project_462000472/akhtar/climate_modeling/pangu-data/data_prep/pm25/pm25_cropped_mergedwithsurface/2019'
...
for surface_file in surface_files:
    ...
    year_month = surface_file.split('_')[1][:6]
    
    # Define the corresponding cams file name
    cams_file = f'cams_{year_month}_025_renamed.nc'
    ...
    if os.path.exists(cams_file_path):
        ...
        output_file_path = os.path.join(output_folder, f'surface_{year_month}.nc')
