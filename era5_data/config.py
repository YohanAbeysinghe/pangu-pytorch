...
__C.GLOBAL.BATCH_SZIE = 1 # @Yohan. Why is this szie. Should I correct it.
for dirs in ['/home/yohan.abeysinghe/Pangu/pangu-pytorch']:
    if os.path.exists(dirs):
        __C.GLOBAL.PATH = dirs
assert __C.GLOBAL.PATH is not None
__C.GLOBAL.SEED =99
__C.GLOBAL.NUM_THREADS = 2 # @THREADS


# __C.ROOT_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
__C.PG_INPUT_PATH = '/l/users/yohan.abeysinghe/pangu_data'
...
__C.PG.TRAIN.END_TIME = '20190110' #'20200531' '20190703'  '20171231'
__C.PG.TRAIN.FREQUENCY = '12h' # @Yohan
...
__C.PG.VAL.START_TIME = '20190101' #'20200201''20200901'
__C.PG.VAL.END_TIME = '20190110' #'20200229''20201231'
