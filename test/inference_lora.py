...
def load_model_for_inference(cfg, output_path, device):
        ...
        for block in [0, 1]:
            ...
            if key in state_dict:
                ...
                if orig_bias.shape[1] > 40:
                    state_dict[key] = orig_bias[:, 30:70, :, :, :]
    ...
    best_model_path = "/l/users/fahad.khan/akhtar/Pangu/data/pangu_data/results/lora_proper_crop_batched_1/models/model_weights_5.pth"
