...
parser.add_argument('--output', type=str, default='proper_crop_mena_train_lora_r16_lowlr', help='Name of the output directory')
...
lora_config = LoraConfig(
    r=8,          # Make sure this is capitalized consistently
    lora_alpha=16,
