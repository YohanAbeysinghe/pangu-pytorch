...
parser.add_argument('--output', type=str, default='proper_crop_mena_train_lora_r32', help='Name of the output directory')
...
lora_config = LoraConfig(
    r=32,          # Make sure this is capitalized consistently
    lora_alpha=64,
